...
cat_CW = zeros(length(x1),length(x1)); % boundary position * x
...
p_adj_mest_postest = p_adj_circshift * (p_theta_m2_postest .* dx1'); % adj * measurement of est
p_adj_mest_postest = p_adj_mest_postest./(dx1*p_adj_mest_postest);
